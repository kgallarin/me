...
<template>
  <animate-presence>
    <motion.div
      ...
      :class="[
        'fixed right-1 z-[100] flex items-center gap-4 rounded-lg bg-white px-4 py-2 text-sm font-medium text-black shadow-lg ring-1 ring-black ring-opacity-5 sm:right-2 md:right-4',
